...
CREATE TABLE `catalogs` ( `id` INT NOT NULL AUTO_INCREMENT , `id_product_type` INT NOT NULL , `id_aliado` INT NOT NULL ,`file_name` VARCHAR(50) NOT NULL , `is_deleted` BOOLEAN NOT NULL DEFAULT FALSE , `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP , `created_by` INT NOT NULL , `updated_at` DATETIME NULL , `updated_by` INT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB;
