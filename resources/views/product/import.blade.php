                        ...
                        <div class="tab-pane fade" id="download-template" role="tabpanel" aria-labelledby="download-template-tab">
                            <div class="container-buttons">
                                <div>
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="Utils.onclick_downloadIDs()">Descargar IDs</button></li>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-primary">Descargar plantilla</button></li>
                                </div>
                            </div>
