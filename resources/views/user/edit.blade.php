                        ...
                        <div class="card-body">
                            <form method="POST" id="formEditUser" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <textarea class="form-control" id="clientAddress" name="clientAddress" rows="3">{{ $user->address }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="container-hidden" id="divContainer">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="form-control" id="companyAddress" name="companyAddress" rows="3">{{ $user->companyAddress }}</textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="companyPhone" type="number" class="form-control" name="companyPhone" value="{{ $user->companyPhone }}">
                                        </div>
                                        @error('companyPhone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
